...
export function ErrorState({ errorMessage, onRetry, onSelectPreset }) {
  ...
  return (
    <div className="panel-module p-8 text-center space-y-6 max-w-2xl mx-auto border-[#e66b5c]">
      <div className="label-plate" style={{ backgroundColor: '#93000a', color: '#ffdad6', borderColor: '#e66b5c' }}>
        Telemetry Fault
      </div>

      <div className="w-12 h-12 rounded-full bg-[#93000a]/20 border-2 border-[#e66b5c] flex items-center justify-center mx-auto text-[#e66b5c] mt-4">
      ...
      <div className="space-y-2">
        ...
        <p className="font-['JetBrains_Mono'] text-xs text-[#dec0b4]">
      ...
      <div className="pt-4 border-t border-[#2d372d] space-y-2">
        <span className="text-[11px] text-[#a68b80] uppercase tracking-wider block font-['IBM_Plex_Sans']">
        ...
        <div className="flex flex-wrap justify-center gap-2">
          {suggestions.map((sub) => (
            <button
              ...
              className="px-2.5 py-1 text-xs font-['JetBrains_Mono'] bg-[#141e15] hover:bg-[#232c22] text-[#f1c043] border border-[#574239]"
            >
              r/{sub}
            </button>
          ))}
